...
1. Pass `cargo test` (~165 Rust unit + integration tests)
2. Pass `npm test` in `tests-sdk/` (~103 integration tests across security, permissions, sessions, session actions)
