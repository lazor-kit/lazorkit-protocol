...
security_txt! {
    ...
    contacts: "email:support@lazorkit.com,link:https://github.com/lazor-kit/lazorkit-protocol/security/advisories/new",
    policy: "https://github.com/lazor-kit/lazorkit-protocol/blob/main/SECURITY.md",
